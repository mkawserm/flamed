...
type IntKeyPayload struct {
	Verb                 Verb     `protobuf:"varint,1,opt,name=verb,proto3,enum=intkeymutator.Verb" json:"verb,omitempty"`
...
func init() {
	proto.RegisterEnum("intkeymutator.Verb", Verb_name, Verb_value)
	proto.RegisterType((*IntKeyState)(nil), "intkeymutator.IntKeyState")
	proto.RegisterType((*IntKeyPayload)(nil), "intkeymutator.IntKeyPayload")
}

func init() { proto.RegisterFile("intkeymutator.proto", fileDescriptor_c97da48b2fb36873) }
